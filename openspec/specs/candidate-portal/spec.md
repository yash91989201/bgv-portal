...
Candidate self-service page of the BGV portal: greeting with current application stage, journey timeline from status history, read-only profile view, and sign-out — always current via Convex reactivity.
